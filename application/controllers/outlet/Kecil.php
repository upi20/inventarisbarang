...
class Kecil extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = 'Outlet - Kecil';
        $this->title_show = false;
        $this->navigation = ['Outlet', 'Kecil'];
        ...
        $this->breadcrumb_3 = 'Kecil';
        $this->breadcrumb_3_url = base_url() . 'outlet/kecil';
        $this->breadcrumb_show = false;

        // content
        $this->content      = 'outlet/kecil';
    ...
    function __construct()
    {
        ...
        $this->load->model("outlet/kecilModel", 'model');
