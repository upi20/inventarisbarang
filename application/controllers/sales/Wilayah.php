...
class Wilayah extends Render_Controller
{
    ...
    public function index()
    {
        // Page Settings
        $this->title = 'Wilayah';
        $this->navigation = ['Sales', 'Wilayah Sales'];
        ...
        $this->breadcrumb_3_url = base_url() . 'sales/wilayah';

        // content
        $this->content      = 'sales/wilayah';
    ...
    public function uploadImage()
    {
        ...
        $config['upload_path']          = './gambar/sales/';
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($sales, $kecamatan, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $kecamatan = $this->input->post("kecamatan");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $sales, $kecamatan, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("sales/wilayahModel", 'model');
...
/* Location: ./application/controllers/sales/Pengguna.php */