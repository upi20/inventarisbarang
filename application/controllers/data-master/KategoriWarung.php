...
class KategoriWarung extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Kategori Warung';
        $this->navigation = ['Data Master', 'Kategori Warung'];
        ...
        $this->breadcrumb_3_url = base_url() . 'data-master/kategori-warung';

        // content
        $this->content      = 'data-master/kategori-warung';
    ...
    // dipakai Administrator |Untuk Insert
    ...
    // dipakai Administrator | UNtuk Ubah data 
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/KategoriWarungModel", 'model');
