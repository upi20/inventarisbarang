...
class Sales extends Render_Controller
{
    ...
    public function index()
    {
        // Page Settings
        $this->title = 'Sales';
        $this->navigation = ['Warung', 'Daftar Sales'];
        ...
        $this->breadcrumb_3_url = base_url() . 'warung/sales';

        // content
        $this->content      = 'warung/sales';
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($warung, $sales, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $sales = $this->input->post("sales");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $warung, $sales, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("warung/salesModel", 'model');
