...
class Daftar extends Render_Controller
{
    ...
    public function index()
    {
        // Page Settings
        $this->title = 'Daftar';
        $this->navigation = ['Data Penggajian', 'Daftar'];
        $this->plugins = ['datatables'];

        // Breadcrumb setting
        $this->breadcrumb_1 = 'Dashboard';
        $this->breadcrumb_1_url = base_url();
        $this->breadcrumb_2 = 'Penggajian';
        $this->breadcrumb_2_url = '#';
        $this->breadcrumb_3 = 'Daftar';
        $this->breadcrumb_3_url = base_url() . 'penggajian/daftar';

        // content
        $this->content      = 'penggajian/daftar';
    ...
    public function uploadImage()
    {
        ...
        $config['upload_path']          = './gambar/penggajian/';
    ...
    public function getDaftar()
    {
        ...
        $result = $this->model->getDaftar($id);
        $code = $result ? 200 : 500;
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($sales, $jumlah, $bonus, $hutang, $total_gaji, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $total_gaji = $this->input->post("total_gaji");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $sales, $jumlah, $bonus, $hutang, $total_gaji, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("penggajian/daftarModel", 'model');
