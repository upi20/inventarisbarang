...
class Daftar extends Render_Controller
{
    ...
    public function index()
    {
        ...
        $this->breadcrumb_3_url = base_url() . 'hutang/daftar';

        // content
        $this->content      = 'hutang/daftar';
    ...
    public function uploadImage()
    {
        ...
        $config['upload_path']          = './gambar/hutang/';
    ...
    function __construct()
    {
        ...
        $this->load->model("hutang/daftarModel", 'model');
