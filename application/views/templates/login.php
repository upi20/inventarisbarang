...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        ...
        <span class="h5"><b>DISTRIBUSI</b><br>Easy Controlling For Bussiness</span>
      </div>
      <div class="card-body">
  ...
  <small class="form-text text-muted">&copy; 2021 Developed by <b>KOPIGADJAH</b></small>
  <!-- /.login-box -->
