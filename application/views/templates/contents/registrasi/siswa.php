<form action="" method="post" id="form-registrasi">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nisn" class="form-control" id="nisn" placeholder="Nomor Induk Siswa Nasional" required>
    </div>
    <div class="form-group">
        <label for="nama">Nama</label>
        <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Lengkap Siswa" required>
    </div>
    <div class="form-group">
