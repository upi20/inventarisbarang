    ...
    <div class="card-header">
        <div class="container-fluid">
            <div class="d-flex justify-content-end  align-items-star w-100 flex-md-row flex-column">
                <h3 class="card-title align-self-center">Filter Stok keluar: </h3>
                ...
                <div class="form-group  mb-lg-0 ml-lg-2">
                    <select class="form-control" id="sales" name="sales" required style="width: 100%;">
...
<div class="card card-primary card-outline">
    <div class="card-header">
        <div class="d-flex justify-content-between w-100">
            <h3 class="card-title">List Stok keluar</h3>
            ...
            <a href="<?= base_url(); ?>stok/keluar/tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
        </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-info py-2">
                <h4 class="modal-title" id="myModalLabel">Detail Stok Keluar</h4>
            ...
            <div class="modal-body">
                <table>
                    ...
                    <tr>
                        <td style="width: 150px;">Tanggal Disimpan</td>
                        <td style="width: 3px;">:</td>
                ...
                <br>
                <label for="detail-stok-keluar">List Produk:</label>
                <table class="table" id="detail-stok-keluar">
                    <thead>
                        <tr>
                    ...
                    <tbody id="detail-stok-keluar-body">
