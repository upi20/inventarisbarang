$(function () {
    ...
    function dynamic(sales, kecamatan, penjualan) {
        ...
        var tableUser = table_html.DataTable({
            "ajax": {
                "url": "<?= base_url()?>outlet/besar/ajax_data/",
                "data": data,
                "type": 'POST'
            },
            "processing": true,
    ...
    ajax_select_kode({ id: '#btn-tambah', pretext: 'Tambah', text: '<i class="fa fa-plus"></i> Tambah' }, '#filter-kecamatan', '<?= base_url(); ?>/outlet/besar/ajax_select_list_kecamatan', null, '#myModal', 'Pilih Kecamatan');
    ajax_select({ id: '#btn-tambah', pretext: 'Tambah', text: '<i class="fa fa-plus"></i> Tambah' }, '#filter-sales', '<?= base_url(); ?>/outlet/besar/ajax_select_list_sales', null, '#myModal', 'Pilih Sales');
    dynamic();
